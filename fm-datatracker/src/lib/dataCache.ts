...
export function preloadSave(saveId: string) { void loadPlayers(saveId).catch(() => undefined) }
export function invalidateSaveData(saveId: string) { players.delete(saveId) }
