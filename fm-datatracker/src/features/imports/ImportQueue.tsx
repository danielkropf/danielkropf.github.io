...
type Job = { id: string; save: Save; name: string; file?: File; csvFile?: File; updateTarget?: ImportUpdateTarget; phase: ImportProgress['phase'] | 'done'; detail: string; stage?: 'reading' | 'writing'; progress?: number; confirmation: number; operation?: 'new' | 'update'; detectedImportId?: string }
