...
const BASELINE_PATH = resolve(process.cwd(), '../tools/fm26-save-reader/baseline/FM26_SaveReader_Web_Portable_v0.22.html')
const baselineIt = existsSync(BASELINE_PATH) ? it : it.skip
...
describe('FM26 offline reader v0.22 characterization', () => {
  baselineIt('preserva a superfície comprovada do núcleo offline, sem Oracle/runtime', () => {
