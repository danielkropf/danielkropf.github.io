...
const EXPECTED_ROLE_MATRIX_KEYS: Record<string, string> = {
  ...
  'IP-FB-WB': 'IP_WB_WING_BACK',
  'IP-FB-IFB': 'IP_FB_INSIDE_FULL_BACK',
  'IP-FB-IWB': 'IP_WB_INSIDE_WING_BACK',
  ...
  'IP-CM-AP': 'IP_CM_ADVANCED_PLAYMAKER',
  'IP-CM-AM': 'IP_AMC_ATTACKING_MIDFIELDER',
  'IP-CM-CHM': 'IP_CM_CHANNEL_MIDFIELDER',
